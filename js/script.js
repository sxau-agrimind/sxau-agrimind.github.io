...
const DATA = {
  ...
  cooperation: [
    ...
    { avatar: '<img src="img/高建华.jpg">', name: "高建华 山西农业大学教授", role: "博士生导师，山西省“三晋英才”，山西省后稷实验室（杂粮生物育种山西省实验室）固定成员", desc: "主要研究方向：1）谷子特色性状相关基因的开发和利用；2）生物育种及相关技术研究。主讲本科生《生物化学》和《生命科学导论》等课程。主讲研究生《研究生常用软件及其应用案例》。",},
  ],
  students: [
