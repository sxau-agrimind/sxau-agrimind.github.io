...
const DATA = {
  ...
  cooperation: [
    ...
    { avatar: '<img src="img/jeff pan.jpeg">', name: "Jeff Z. Pan 爱丁堡大学教授", role: "博士生导师，教育部长江学者讲座教授", desc: "现任The University of Edinburgh信息学院教授，曾在The University of Aberdeen等高校任教；长期从事人工智能领域知识图谱、语义网、知识表示与推理等方向研究，在相关国际顶级会议（如ISWC等）和重要期刊发表论文数百篇，研究工作参与并推动了World Wide Web Consortium语义网核心标准（如OWL）的发展；曾担任国际会议程序委员会主席等学术服务职务，同时与工业界保持紧密合作。",},
  ...
  papers: [
    { year: "2026", venue: "Neurocomputing", title: "Leveraging Intra-modal and Inter-modal Interaction for Multi-Modal Entity Alignment", authors: "Zhiwei Hu, Víctor Gutiérrez-Basulto, Zhiliang Xiang, Ru Li, Jeff Z. Pan.", badges: [{ text: "SCI 2区", highlight: true }, { text: "知识图谱", highlight: false }, { text: "实体对齐", highlight: false }] },
    { year: "2025", venue: "KDD", title: "Multi-level Mixture of Experts for Multimodal Entity Linking", authors: "Zhiwei Hu, Víctor Gutiérrez-Basulto, Zhiliang Xiang, Ru Li, Jeff Z. Pan.", badges: [{ text: "CCF-A", highlight: true }, { text: "知识图谱", highlight: false }, { text: "多模态实体链接", highlight: false }] },
    { year: "2025", venue: "KDD", title: "Multi-level Matching Network for Multimodal Entity Linking", authors: "Zhiwei Hu, Víctor Gutiérrez-Basulto, Ru Li, Jeff Z. Pan.", badges: [{ text: "CCF-A", highlight: true }, { text: "知识图谱", highlight: false }, { text: "多模态实体链接", highlight: false }] },
    { year: "2023", venue: "EMNLP", title: "Multi-view Contrastive Learning for Entity Typing over Knowledge Graphs", authors: "Zhiwei Hu, Víctor Gutiérrez-Basulto, Zhiliang Xiang, Ru Li, Jeff Z. Pan.", badges: [{ text: "CCF-B", highlight: true }, { text: "知识表示", highlight: false }, { text: "实体类型推理", highlight: false }] },
    { year: "2023", venue: "CIKM", title: "HyperFormer: Enhancing Entity and Relation Interaction for Hyper-Relational Knowledge Graph Completion", authors: "Zhiwei Hu, Víctor Gutiérrez-Basulto, Zhiliang Xiang, Ru Li, Jeff Z. Pan.", badges: [{ text: "CCF-B", highlight: true }, { text: "知识表示", highlight: false }, { text: "超关系知识图谱补全", highlight: false }] },
    { year: "2023", venue: "Animals", title: "Attention-Guided Instance Segmentation for Group-Raised Pigs", authors: "Zhiwei Hu, Hua Yang, Hongwen Yan.", badges: [{ text: "SCI 2区", highlight: true }, { text: "计算机视觉", highlight: false }, { text: "注意力机制", highlight: false }] },
    { year: "2023", venue: "IJABE", title: "Concurrent Channel and Spatial Attention in Fully Convolutional Network for Individual Pig Image Segmentation", authors: "Zhiwei Hu, Hua Yang, Tiantian Lou, Hongwen Yan.", badges: [{ text: "SCI 2区", highlight: true }, { text: "计算机视觉", highlight: false }, { text: "注意力机制", highlight: false }] },
    { year: "2023", venue: "IJABE", title: "Parallel Channel and Position Attention-guided Feature Pyramid for Pig Face Posture Detection", authors: "Zhiwei Hu, Hongwen Yan, Tiantian Lou.", badges: [{ text: "SCI 2区", highlight: true }, { text: "计算机视觉", highlight: false }, { text: "注意力机制", highlight: false }] },
